...
int main()
{
	...
	glBindBuffer(GL_ARRAY_BUFFER, VB O);
	...
	Shader lightingShader("./resources/shaders/Cube.vs", "./resources/shaders/Cube.fs");
	Shader lightCubeShader("./resources/shaders/Light.vs", "./resources/shaders/Light.fs");
