...
int main()
{
	...
	Shader lightingShader("resource/shader/Cube.vs", "resource/shader/Cube.fs");
	Shader lightCubeShader("resource/shader/Light.vs", "resource/shader/Light.fs");
	...
	unsigned int emissionMap = loadTexture("resource/textures/matrix.jpg");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		lightingShader.setFloat("light.cutOff", glm::cos(glm::radians(17.f)));
		...
		timestep = timestep - (int)timestep;
		lightingShader.setFloat("timestep", timestep);
